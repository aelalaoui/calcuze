...
<head>
    ...
    <title>Calculatrice Universelle - Calcuze</title>
    <meta name="description" content="Calculatrice professionnelle en ligne avec fonctions scientifiques, économiques et de conversion d'unités. Outil de calcul gratuit pour étudiants, professionnels et entreprises.">
    <meta name="keywords" content="calculatrice, calculatrice scientifique, calculatrice économique, convertisseur d'unités, outil mathématique, calculatrice en ligne, calculatrice gratuite">
...
<div class="min-h-screen grid grid-rows-[auto_1fr_auto] grid-cols-1 md:grid-cols-[250px_1fr_250px] lg:grid-cols-[300px_1fr_300px] gap-4 p-4">
    ...
    <!-- En-tête supérieur avec logo et publicité -->
    <div class="col-span-full grid grid-cols-1 md:grid-cols-[250px_1fr] lg:grid-cols-[300px_1fr] gap-4">
        ...
        <div class="ad-banner rounded-xl p-6 flex items-center justify-center">
            <div class="text-white text-center">
                <h2 class="text-2xl font-bold mb-2">🎯 ESPACE PUBLICITAIRE PREMIUM</h2>
                <p class="text-lg opacity-90">Votre publicité pourrait être ici !</p>
                <p class="text-sm opacity-75">Contactez-nous pour une visibilité premium</p>
            </div>
        </div>
    </div>
    ...
    <div class="ad-banner rounded-xl p-4 flex-col items-center justify-center hidden md:flex">
        <div class="text-white text-center">
            ...
            <div class="space-y-2 text-xs opacity-75">
                ...
                <p>• Audience professionnelle</p>
                <p>• Positionnement premium</p>
            </div>
    ...
    <!-- Section calculatrice (contenu principal) -->
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden col-span-1">
        <!-- En-tête avec sélection de mode -->
        <div class="bg-blue-600 p-4 text-white">
            <h1 class="text-xl font-bold text-center">Calculatrice Universelle</h1>
            <div class="flex justify-between mt-3 space-x-1">
                <button id="normal-mode" class="mode-btn active flex-1 py-2 rounded-lg text-sm font-medium">Normale</button>
                <button id="scientific-mode" class="mode-btn flex-1 py-2 rounded-lg text-sm font-medium">Scientifique</button>
                <button id="economic-mode" class="mode-btn flex-1 py-2 rounded-lg text-sm font-medium">Économique</button>
        ...
        <!-- Calculatrice scientifique (cachée par défaut) -->
        ...
        <!-- Calculatrice économique (cachée par défaut) -->
        <div id="economic-calculator" class="calculator-section hidden p-4">
            <div class="grid grid-cols-3 gap-3 mb-3">
                <button class="calculator-btn bg-gray-200 hover:bg-gray-300 rounded-lg p-3 text-sm font-medium" onclick="economicOperation('fv')">VF</button>
                <button class="calculator-btn bg-gray-200 hover:bg-gray-300 rounded-lg p-3 text-sm font-medium" onclick="economicOperation('pv')">VA</button>
                ...
                <button class="calculator-btn bg-gray-200 hover:bg-gray-300 rounded-lg p-3 text-sm font-medium" onclick="economicOperation('npv')">VAN</button>
                <button class="calculator-btn bg-gray-200 hover:bg-gray-300 rounded-lg p-3 text-sm font-medium" onclick="economicOperation('irr')">TRI</button>
            ...
            <div class="bg-gray-100 p-3 rounded-lg mb-3">
                <div class="grid grid-cols-2 gap-2 mb-2">
                    <div>
                        <label class="block text-xs text-gray-600 mb-1">Capital (P)</label>
                        <input type="number" id="principal" class="w-full p-2 border rounded">
                    </div>
                    <div>
                        <label class="block text-xs text-gray-600 mb-1">Taux (r)</label>
                        <input type="number" id="rate" class="w-full p-2 border rounded">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-2 mb-2">
                    <div>
                        <label class="block text-xs text-gray-600 mb-1">Durée (t)</label>
                        <input type="number" id="time" class="w-full p-2 border rounded">
                    </div>
                    <div>
                        <label class="block text-xs text-gray-600 mb-1">Périodes (n)</label>
                        <input type="number" id="periods" class="w-full p-2 border rounded">
                    </div>
                </div>
                <div>
                    <label class="block text-xs text-gray-600 mb-1">Paiement (PMT)</label>
        ...
        <!-- Calculatrice de conversion (cachée par défaut) -->
        ...
        <div id="history-panel" class="hidden absolute top-0 left-0 w-full h-full bg-white bg-opacity-95 z-10 p-4 overflow-y-auto">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold">Historique des Calculs</h2>
    ...
    <div class="history-sidebar rounded-xl p-4 hidden md:block">
        ...
        <div id="sidebar-history" class="space-y-2 max-h-96 overflow-y-auto">
            <div class="text-gray-500 text-sm text-center py-8">
                ...
                <p class="text-xs">Commencez à calculer pour voir l'historique</p>
            </div>
        </div>
        ...
        <div class="mt-6 pt-4 border-t border-gray-300">
            ...
            <div class="space-y-2">
                ...
                <button onclick="importHistory()" class="w-full text-left text-sm text-green-600 hover:text-green-800 flex items-center">
                    ...
                    <span>Importer l'Historique</span>
                </button>
            </div>
        </div>
    </div>
    ...
    <div class="col-span-full seo-footer rounded-xl p-6">
        <div class="text-center mb-6">
            ...
            <p class="text-gray-600">Outils de Calculatrice Professionnelle & Solutions Mathématiques</p>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            <div>
                <h3 class="font-semibold text-gray-800 mb-3">Fonctionnalités de la Calculatrice</h3>
                <ul class="space-y-1 text-gray-600">
                    <li>• Opérations arithmétiques de base</li>
                    <li>• Calculs scientifiques</li>
                    <li>• Formules économiques</li>
                    <li>• Conversions d'unités</li>
                    <li>• Suivi de l'historique</li>
                </ul>
            </div>

            <div>
                <h3 class="font-semibold text-gray-800 mb-3">Opérations Supportées</h3>
                <ul class="space-y-1 text-gray-600">
                    <li>• Fonctions trigonométriques</li>
                    <li>• Logarithmes et exponentielles</li>
                    <li>• Calculs financiers</li>
                    <li>• Conversion de température</li>
                    <li>• Unités de longueur et poids</li>
                </ul>
            </div>

            <div>
                <h3 class="font-semibold text-gray-800 mb-3">Avantages</h3>
                <ul class="space-y-1 text-gray-600">
                    <li>• Calculatrice en ligne gratuite</li>
        ...
        <div class="mt-6 pt-4 border-t border-gray-300 text-center text-xs text-gray-500">
            <p>&copy; <span id="current-year"></span> Calcuze - Calculatrice Universelle. Tous droits réservés.</p>
            <p>
